...
class _VehicleFormPageState extends State<VehicleFormPage> {
  ...
  void _loadVehicleData() {
    ...
    final vehicle = provider.vehicles.firstWhere(
      ...
      orElse: () => provider.vehicles.first,
    );
  ...
  Future<void> _saveVehicle() async {
    ...
    try {
      ...
      if (widget.vehicleId != null) {
        ...
        vehicle = await _supabaseService.getVehicleById(widget.vehicleId!);
      } else {
        vehicle = await _supabaseService.createVehicle(vehicleData);
      ...
      if (mounted) {
        ...
        if (e is PostgrestException) {
          ...
          if (e.code == '23505' ||
            ...
            errorMessage = 'Vehicle not found. Please refresh and try again.';
          } else {
    ...
    return ResponsiveLayout(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title:
              Text(widget.vehicleId != null ? 'Edit Vehicle' : 'Add Vehicle'),
          actions: [
            if (_isLoading)
              const Padding(
