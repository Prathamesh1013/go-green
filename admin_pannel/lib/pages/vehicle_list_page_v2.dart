...
class CoreVehicleListPageV2 extends StatefulWidget {
  const CoreVehicleListPageV2({super.key});

  @override
  State<CoreVehicleListPageV2> createState() => _CoreVehicleListPageV2State();
}

class _CoreVehicleListPageV2State extends State<CoreVehicleListPageV2> {
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            // CoreVehicle Table with Glassmorphism
            Expanded(
              child: _buildCoreVehicleTable(),
            ),
          ],
        ),
      ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: TextField(
                  ...
                  suffixIcon: _searchController.text.isNotEmpty
                      ? IconButton(
                          ...
                          onPressed: () {
                            ...
                            context.read<CoreVehicleProvider>().setSearchQuery('');
                            setState(() {});
                          },
                        )
                      : null,
                ...
                onChanged: (value) {
                  context.read<CoreVehicleProvider>().setSearchQuery(value);
                  setState(() {});
                },
              ),
            ),
          ...
          // Add Button
          ElevatedButton.icon(
            onPressed: () => context.go('/coreVehicles/new'),
  ...
  Widget _buildSummaryStats() {
    return Consumer<CoreVehicleProvider>(
      builder: (context, provider, _) {
        final vehicles = provider.filteredCoreVehicles;
  ...
  Widget _buildCoreVehicleTable() {
    return Consumer<CoreVehicleProvider>(
      builder: (context, provider, _) {
        ...
        var vehicles = provider.filteredCoreVehicles;
...
class _CoreVehicleTableRow extends StatelessWidget {
  final CoreVehicle vehicle;
  final VoidCallback onTap;

  const _CoreVehicleTableRow({
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Expanded(
              child: Text(
                'CoreVehicle No. ${vehicle.vehicleNumber}',
