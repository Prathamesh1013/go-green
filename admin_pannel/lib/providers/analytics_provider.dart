...
class AnalyticsProvider extends ChangeNotifier {
  ...
  void _calculateKPIs(List<CoreVehicle> vehicles, List<MaintenanceJob> jobs) {
  ...
  void _generateRecommendations(List<CoreVehicle> vehicles, List<MaintenanceJob> jobs) {
    _recommendations = [
