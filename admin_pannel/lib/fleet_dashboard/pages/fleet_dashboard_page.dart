...
class _FleetDashboardPageState extends State<FleetDashboardPage> {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: NestedScrollView(
          ...
          body: Consumer3<AnalyticsProvider, CoreVehicleProvider, JobProvider>(
              ...
              children: [
                Expanded(
                  child: KPICard(
                    ...
                    value: '${kpis.activeCoreVehicles.total}',
                    subtext: '${kpis.activeCoreVehicles.evPercentage.toStringAsFixed(1)}% EV (${kpis.activeCoreVehicles.ev}), ${ (100 - kpis.activeCoreVehicles.evPercentage).toStringAsFixed(1)}% ICE (${kpis.activeCoreVehicles.ice})',
  ...
  Widget _buildVehicleTracking(CoreVehicleProvider provider) {
    // Map Core Vehicle to Dashboard Vehicle
    final mappedVehicles = provider.coreVehicles.map((v) {
      final coreV = v;
