...
class SupabaseService {
  ...
  Future<List<CoreVehicle>> getCoreVehicles({
    String? status,
    String? healthState,
    String? hubId,
  }) async {
    try {
      ...
      final vehicles = (response as List).map((json) => CoreVehicle.fromJson(json)).toList();
  ...
  Future<CoreVehicle?> getCoreVehicleByRegistrationNumber(String registrationNumber) async {
    try {
      ...
      return CoreVehicle.fromJson(response);
    } catch (e) {
      throw Exception('Error fetching vehicle by registration number: $e');
    }
  }

  Future<CoreVehicle> getCoreVehicleById(String vehicleId) async {
    try {
      final response = await _client
          .from('crm_vehicles')
          .select('*')
      ...
      var vehicle = CoreVehicle.fromJson(response);
  ...
  Future<Map<String, dynamic>?> getCoreVehicleWithCustomer(String vehicleId) async {
    try {
      final response = await _client
          .from('crm_vehicles')
          .select('*')
  ...
  Future<CoreVehicle> createCoreVehicle(Map<String, dynamic> data) async {
    try {
      final response = await _client
          .from('crm_vehicles')
          .insert(data)
  ...
  Future<CoreVehicle> updateCoreVehicle(String vehicleId, Map<String, dynamic> data) async {
    try {
      final response = await _client
          .from('crm_vehicles')
          .update(data)
  ...
  Future<List<MaintenanceJob>> getMaintenanceJobsByCoreVehicleId(String vehicleId) async {
    try {
      final response = await _client
          .from('maintenance_job')
          .select('*')
