...
class _VehicleSummaryScreenState extends State<VehicleSummaryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Inspection Summary', style: TextStyle(fontWeight: FontWeight.bold)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (inspection != null) ...[
              const Text('Inspection Checklist', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(LucideIcons.car, color: AppTheme.primaryBlue, size: 32),
          ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Row(
                children: [
                  Text('View Details', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppTheme.dangerRed)),
                  Icon(LucideIcons.chevronRight, size: 14, color: AppTheme.dangerRed),
                ],
              ),
            ],
          ),
              ...
              Container(
                ...
                child: const Column(
                  children: [
                    ...
                    SizedBox(height: 12),
                    Text('Video captured', style: TextStyle(fontWeight: FontWeight.bold)),
                    Text('Playback available in full report', style: TextStyle(fontSize: 12, color: Colors.grey)),
                  ],
                ),
              ),
            ],
  ...
  void _confirmDelete(BuildContext context, ReportedIssue issue) {
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text('Are you sure you want to remove this reported issue? This action cannot be undone.'),
        actions: [
          TextButton(
            ...
            onPressed: () async {
              ...
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Issue removed successfuly')),
                );
              }
            },
  ...
  Widget _buildEmptyIssues() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFF3F4F6),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: const Color(0xFFE5E7EB), style: BorderStyle.none),
      ),
      child: const Center(
        child: Text('No issues reported during this inspection.', style: TextStyle(color: Color(0xFF9CA3AF))),
      ),
    );
  }
}
